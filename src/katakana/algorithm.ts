...
import { ROWS, ALL_CHARS } from './katakana';
import { UNLOCK_CORRECT } from '../hiragana/constants';
...
function weight(char: KatakanaChar, mastery: MasteryMap, now: number): number {
